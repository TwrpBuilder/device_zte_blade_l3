...
TARGET_BOOTLOADER_BOARD_NAME := Blade_L3

# Platform
TARGET_BOARD_PLATFORM := MT6582M
...
# Kernel
TARGET_PREBUILT_KERNEL := device/zte/blade_l3/kernel
BOARD_KERNEL_CMDLINE :=
BOARD_CUSTOM_BOOTIMG_MK := device/zte/blade_l3/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/zte/blade_l3/recovery/etc/twrp.fstab
